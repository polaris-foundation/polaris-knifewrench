...
The Knife Wrench API is part of the Polaris platform (formerly DHOS). This service is for managing errored AMQP messages.
...
<!-- markdown-swagger -->
 ...
 `/dhos/v1/amqp_message`                          | POST   | Yes   | Create a record of an errored AMQP message                                                                                 
 `/dhos/v1/amqp_message`                          | GET    | No    | Get a list of errored AMQP messages                                                                                        
 `/dhos/v1/amqp_message/{message_uuid}`           | GET    | No    | Get an errored AMQP message by UUID                                                                                        
 `/dhos/v1/amqp_message/{message_uuid}/republish` | POST   | Yes   | Republish an errored AMQP message by UUID using its routing key. Responds with a 204 on successful republish.              
 `/dhos/v1/amqp_message/republish`                | POST   | Yes   | Republish multiple errored AMQP message using its routing key. Responds with a 204 on successful republish of all messages.
<!-- /markdown-swagger -->
...
## Database
Errored AMQP messages are stored in a Postgres database.
